...
public class FriendshipServiceImpl implements FriendshipService {
    ...
    public void acceptFriendship(int user1Id, int user2Id) {
        friendshipMapper.acceptFriendship(user2Id, user1Id);
        friendshipMapper.createFriendship(user1Id, user2Id);
    }
    public void rejectFriendship(int user1Id, int user2Id) {
        friendshipMapper.rejectFriendship(user2Id, user1Id);
    }
